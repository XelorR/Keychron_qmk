...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_FUN] = LAYOUT_73_jis(
        ...
        CL_CTRL,  KC_F11,   KC_F4,    KC_F5,    KC_F6,    MC_PSCR,            CW_TOGG,  OS_SHFT,  OS_CMD,   OS_ALT,   OS_CTRL,  ES_SWAP,  _______,  _______,  _______,
        CL_CAPS,  KC_F10,   KC_F1,    KC_F2,    KC_F3,    MC_KILL,  BAT_LVL,  MC_APP,   KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_BRK,   ES_NORM,  _______,  _______,
    ...
    [WIN_FUN] = LAYOUT_73_jis(
        ...
        CL_CTRL,  KC_F11,   KC_F4,    KC_F5,    KC_F6,    KC_PSCR,            CW_TOGG,  OS_SHFT,  OS_CTRL,  OS_ALT,   OS_CMD,   ES_SWAP,  _______,  _______,  _______,
        CL_CAPS,  KC_F10,   KC_F1,    KC_F2,    KC_F3,    WN_KILL,  BAT_LVL,  KC_APP,   KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_BRK,   ES_NORM,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,            _______,  _______,            _______,  _______,  _______)
};
