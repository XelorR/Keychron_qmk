...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [MAC_SYM] = LAYOUT_73_jis(
        ...
        _______,  KC_TILD,  KC_EXLM,  KC_AT,    KC_HASH,  KC_PIPE,  BAT_LVL,  UC_SNUB,  KC_PSLS,  MC_EMOJ,  KC_PDOT,  UC_SNUH,  _______,  _______,  KC_PGUP,
    ...
    [MAC_NUM] = LAYOUT_73_jis(
        ...
        _______,  KC_GRV,   KC_1,     KC_2,     KC_3,     KC_BSLS,  _______,  KC_NUBS,  KC_PSLS,  MC_EMOJ,  KC_PDOT,  KC_NUHS,  _______,  _______,  _______,
    ...
    [MAC_FUN] = LAYOUT_73_jis(
        ...
        CL_CTRL,  KC_F11,   KC_F4,    KC_F5,    KC_F6,    MC_PSCR,            CW_TOGG,  OS_SHFT,  OS_CMD,   OS_ALT,   OS_CTRL,  _______,  _______,  _______,  _______,
    ...
    [WIN_FUN] = LAYOUT_73_jis(
        ...
        CL_CTRL,  KC_F11,   KC_F4,    KC_F5,    KC_F6,    KC_PSCR,            CW_TOGG,  OS_SHFT,  OS_CTRL,  OS_ALT,   OS_CMD,   _______,  _______,  _______,  _______,
