...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [U_NUM] = LAYOUT_73_jis(
        ...
        _______,           KC_QUOT,           KC_4,              KC_5,              KC_6,              KC_EQL,            U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,              _______,  _______,  _______,  _______,
    ...
    [U_SYM] = LAYOUT_73_jis(
        ...
        _______,           KC_DQUO,           KC_DLR,            KC_PERC,           KC_CIRC,           KC_PLUS,           TD(U_TD_GAM),      KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,              _______,  _______,  _______,  _______,
