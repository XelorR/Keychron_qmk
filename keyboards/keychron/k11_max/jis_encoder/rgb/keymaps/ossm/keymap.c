...
#define LA_MEDWN MO(WIN_MEDIA)
#define LA_MEDMC MO(MAC_MEDIA)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_73_jis(
        ...
        KC_LCTL,  KC_LCMMD, KC_LOPTN, KC_LCMMD, KC_SPC,   LA_NAV_M,           LA_SYM_M, KC_LSFT,            KC_RALT,  KC_RCMMD,           KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [WIN_BASE] = LAYOUT_73_jis(
        ...
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,               KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_ENT,   KC_ENT,   KC_HOME,
        KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,  KC_RSFT,  KC_UP,
        KC_LCTL,  KC_LCTL,  KC_LWIN,  KC_LALT,  KC_SPC,   LA_NAV_W,           LA_SYM_W, KC_LSFT,            KC_RALT,  KC_RCTL,            KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [MAC_NUM] = LAYOUT_73_jis(
        ...
        CL_CTRL,  OS_CTRL,  OS_ALT,   OS_CMD,   OS_SHFT,  KC_F11,             KC_F12,   OS_SHFT,  OS_CMD,   OS_ALT,   OS_CTRL,  EC_SWAP,  _______,  _______,  _______,
        CL_CAPS,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    BAT_LVL,  KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   EC_NORM,  _______,  _______,
    ...
    [WIN_NUM] = LAYOUT_73_jis(
        ...
        _______,  KC_1,     KC_2,     KC_3,     KC_4,     KC_5,               KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     _______,  _______,            _______,
        CL_CTRL,  OS_CMD,   OS_ALT,   OS_CTRL,  OS_SHFT,  KC_F11,             KC_F12,   OS_SHFT,  OS_CTRL,  OS_ALT,   OS_CMD,   EC_SWAP,  _______,  _______,  _______,
        CL_CAPS,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    BAT_LVL,  KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   EC_NORM,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,            _______,  _______,            _______,  _______,  _______),
    ...
    [MAC_NAV] = LAYOUT_73_jis(
        ...
        _______,  _______,  _______,  _______,  LA_MEDWN, _______,            _______,  MC_LANG,            _______,  _______,            KC_HOME,  KC_PGDN,  KC_END),
    ...
    [WIN_NAV] = LAYOUT_73_jis(
        ...
        _______,  _______,  _______,  _______,  LA_MEDWN, _______,            _______,  WN_LANG,            _______,  _______,            KC_HOME,  KC_PGDN,  KC_END),
    ...
    [MAC_MEDIA] = LAYOUT_73_jis(
        ...
        _______,  KC_APP,   KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,  BAT_LVL,  KC_VOLD,  KC_BSPC,  UC_LAN1,  UC_LAN2,  KC_DEL,   _______,  _______,  _______,
    ...
    const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
        ...
        [MAC_MEDIA]  = { ENCODER_CCW_CW(MS_WHLU, MS_WHLD)},
        [WIN_MEDIA]  = { ENCODER_CCW_CW(MS_WHLU, MS_WHLD)},
    };
