...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [U_EXTRA] = LAYOUT_73_jis(
        ...
        KC_ESC,            LGUI_T(KC_N),      LALT_T(KC_R),      LCTL_T(KC_T),      LSFT_T(KC_S),      KC_G,              KC_Y,              LSFT_T(KC_H),      LCTL_T(KC_A),      LALT_T(KC_E),      LGUI_T(KC_I),         KC_SLSH,  KC_ENT,   KC_ENT,   KC_HOME,
    ...
    [U_GAM_FN] = LAYOUT_73_jis(
        _______,           KC_F1,             KC_F2,             KC_F3,             KC_F4,             KC_F5,             KC_F6,             KC_F7,             KC_F8,             KC_F9,             KC_F10,               KC_F11,   KC_F12,   _______,  _______,  RGB_TOG,
        KC_J,              KC_DOT,            KC_7,              KC_8,              KC_9,              KC_GRV,            KC_INS,            KC_HOME,           KC_UP,             KC_END,            KC_PGUP,              _______,  _______,            _______,
        KC_I,              KC_COMM,           KC_4,              KC_5,              KC_6,              KC_H,              CW_TOGG,           KC_LEFT,           KC_DOWN,           KC_RGHT,           KC_PGDN,              _______,  _______,  _______,  _______,
        KC_M,              KC_SLSH,           KC_1,              KC_2,              KC_3,              KC_MUTE, BAT_LVL,  U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,                _______,  _______,  _______,
