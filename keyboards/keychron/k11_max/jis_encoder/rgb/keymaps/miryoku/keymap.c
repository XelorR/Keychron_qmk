...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [U_BASE] = LAYOUT_73_jis(
        ...
        KC_ESC,            LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_SCLN),      KC_QUOT,  KC_ENT,   KC_ENT,   KC_HOME,
        ...
        KC_LCTL,           U_WIN,             U_ALT,             LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_SPC),  LT(U_MOUSE,KC_TAB),LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  U_CMD,                                             KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [U_EXTRA] = LAYOUT_73_jis(
        ...
        KC_ESC,            LGUI_T(KC_A),      LALT_T(KC_S),      LCTL_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LCTL_T(KC_K),      LALT_T(KC_L),      LGUI_T(KC_SCLN),      KC_QUOT,  KC_ENT,   KC_ENT,   KC_HOME,
        KC_LSFT,           LT(U_BUTTON,KC_Z), ALGR_T(KC_X),      KC_C,              KC_V,              KC_B,     KC_B,    KC_N,              KC_M,              KC_COMM,           ALGR_T(KC_DOT),    LT(U_BUTTON,KC_SLSH), KC_RSFT,  KC_RSFT,  KC_UP,
        KC_LCTL,           U_WIN,             U_ALT,             LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_SPC),  LT(U_MOUSE,KC_TAB),LT(U_SYM_EX,KC_ENT),LT(U_NUM,KC_BSPC),LT(U_FUN,KC_DEL),  U_CMD,                                             KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [U_TAP] = LAYOUT_73_jis(
        ...
        KC_LCTL,           U_CMD,             U_WIN,             U_ALT,             KC_SPC,            MO(U_MOUSE),       LT(U_NUM,KC_ENT),  KC_SPC,            KC_RALT,           U_CMD,                                             KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [U_NAV] = LAYOUT_73_jis(
        ...
        _______,           TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              KC_INS,            KC_HOME,           KC_UP,             KC_END,            KC_PGUP,              _______,     _______,               _______,
        _______,           KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              CW_TOGG,           KC_LEFT,           KC_DOWN,           KC_RGHT,           KC_PGDN,              QK_MACRO_0,  QK_MACRO_1,  _______,  _______,
        _______,           U_NA,              KC_ALGR,           TD(U_TD_U_NUM),    TD(U_TD_U_NAV),    U_NA,    BAT_LVL,  U_RDO,             U_PST,             U_CPY,             U_CUT,             U_UND,                QK_MACRO_2,  QK_MACRO_3,  _______,
    ...
    [U_MEDIA] = LAYOUT_73_jis(
        ...
        _______,           TD(U_TD_BOOT),     TD(U_TD_U_TAP),    TD(U_TD_U_EXTRA),  TD(U_TD_U_BASE),   U_NA,              RGB_TOG,           RGB_MOD,           KC_VOLU,           RGB_HUI,           RGB_SAI,              _______,  _______,            _______,
        _______,           KC_LGUI,           KC_LALT,           KC_LCTL,           KC_LSFT,           U_NA,              U_NU,              KC_MPRV,           KC_VOLD,           KC_MNXT,           RGB_VAI,              _______,  _______,  _______,  _______,
    ...
    [U_NUM] = LAYOUT_73_jis(
        _______,           KC_BRID,           KC_BRIU,           U_MCTL,            U_MYCM,            RGB_VAD,           RGB_VAI,           KC_MPRV,           KC_MPLY,           KC_MNXT,           KC_MUTE,              KC_VOLD,  KC_VOLU,  _______,  _______,  RGB_TOG,
        _______,           KC_SLSH,           KC_7,              KC_8,              KC_9,              KC_MINS,           U_NA,              TD(U_TD_U_BASE),   TD(U_TD_U_EXTRA),  TD(U_TD_U_TAP),    TD(U_TD_BOOT),        _______,  _______,            _______,
        KC_NUBS,           KC_ASTR,           KC_4,              KC_5,              KC_6,              KC_PLUS,           U_NA,              KC_LSFT,           KC_LCTL,           KC_LALT,           KC_LGUI,              _______,  _______,  _______,  _______,
        _______,           KC_EQL,            KC_1,              KC_2,              KC_3,              KC_DOT,  BAT_LVL,  U_NA,              TD(U_TD_U_NUM),    TD(U_TD_U_NAV),    KC_ALGR,           U_NA,                 _______,  _______,  _______,
        _______,           _______,           _______,           _______,           KC_SPC,            KC_0,              U_NA,              U_NA,              U_NA,              _______,                                           _______,  _______,  _______),

    [U_SYM] = LAYOUT_73_jis(
        _______,           KC_BRID,           KC_BRIU,           U_MCTL,            U_MYCM,            RGB_VAD,           RGB_VAI,           KC_MPRV,           KC_MPLY,           KC_MNXT,           KC_MUTE,              KC_VOLD,  KC_VOLU,  _______,  _______,  RGB_TOG,
        _______,           KC_GRV,            KC_LABK,           KC_EQL,            KC_RABK,           KC_DQT,            KC_CIRC,           KC_LCBR,           KC_DLR,            KC_RCBR,           TD(U_TD_BOOT),        _______,  _______,            _______,
        ...
        _______,           KC_HASH,           KC_EXLM,           KC_COLN,           KC_SLSH,           KC_AT,   BAT_LVL,  U_NA,              KC_PIPE,           KC_TILD,           KC_AMPR,           U_NA,                 _______,  _______,  _______,
    ...
    [U_SYM_EX] = LAYOUT_73_jis(
        ...
        S(KC_NUBS),        KC_ASTR,           KC_LPRN,           KC_MINS,           KC_RPRN,           KC_PLUS,           KC_PERC,           KC_LBRC,           KC_DLR,            KC_RBRC,           KC_BSLS,              _______,  _______,  _______,  _______,
    ...
    const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
        ...
        [U_NAV] = { ENCODER_CCW_CW(BSPC_5, MINS_5)},
        [U_MOUSE] = { ENCODER_CCW_CW(BSPC_5, MINS_5)},
        [U_MEDIA]  = { ENCODER_CCW_CW(BSPC_5, MINS_5)},
        [U_SYM]  = { ENCODER_CCW_CW(U_UND, U_RDO)},
        [U_SYM_EX]  = { ENCODER_CCW_CW(U_UND, U_RDO)},
        [U_NUM]  = { ENCODER_CCW_CW(U_UND, U_RDO)},
        [U_FUN]  = { ENCODER_CCW_CW(U_UND, U_RDO)},
    };
