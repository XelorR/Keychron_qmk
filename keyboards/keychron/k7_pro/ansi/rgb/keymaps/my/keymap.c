...
#define LANG_ENG C(KC_8) // QK_MACRO_1 - want to specify macro, but it doesn't work by some reason, so, hardcoded :-(
#define LANG_RUS C(KC_9) // QK_MACRO_2 - want to specify macro, but it doesn't work by some reason, so, hardcoded :-(
...
[FN2] = LAYOUT_ansi_68(
     ...
     DM_REC1,  DM_RSTP,  DM_PLY1,                                KC_TRNS,                                KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS),
};
